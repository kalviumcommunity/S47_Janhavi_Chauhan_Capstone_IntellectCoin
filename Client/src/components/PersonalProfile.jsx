...
// import Navbar from '../components/HomePageComponent/';
...
const PersonalProfile = () => {
 ...
 <div className={styles.contact}>
          ...
          <p className={styles.firstname}> {userData.firstName} {userData.lastName}  <Link to="/completeprofile">
        <FontAwesomeIcon icon={faPenToSquare}  className={styles.icon}/>
          ...
          <p className={styles.college}> {userData.Degree} | | {userData.CollegeName} | | {userData.YearOfStudy}  </p>
